function onCreate()
	for i = 0, getProperty('unspawnNotes.length')-1 do
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'template Note5' then
...
function goodNoteHit(id, noteData, noteType, isSustainNote)
	if noteData == 0 and noteType == 'template Note5' then
		characterPlayAnim('boyfriend', 'shootLEFT', true);
			setProperty('boyfriend.specialAnim', true)
	elseif noteData == 1 and noteType == 'template Note5' then
		characterPlayAnim('boyfriend', 'shootDOWN', true);
			setProperty('boyfriend.specialAnim', true)
	elseif noteData == 2 and noteType == 'template Note5' then
		characterPlayAnim('boyfriend', 'shootUP', true);
			setProperty('boyfriend.specialAnim', true)
	elseif noteData == 3 and noteType == 'template Note5' then
		characterPlayAnim('boyfriend', 'shootRIGHT', true);
			setProperty('boyfriend.specialAnim', true)
	end
	if noteType == 'template Note5' then
